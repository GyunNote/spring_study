...
public class AccountMailService {
    ...
    public boolean sendAuthMail(){
        ...
        try {
            ...
            javaMailSender.send(mimeMessage);  //최종 메일 전송
            result = true;
    ...
    public Map<String,Object> authenticate(String token){
        ...
        try{
            ...
            RoleRegister roleRegister = userMapper.findRoleReigsterByUserIdAndRoleId(userId,2);
            ...
            resultMap = Map.of("status", false, "message", "인증 시간이 초과되었습니다. \n인증 메일을 다시 받으세요.");
